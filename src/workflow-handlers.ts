  ...
  return {
    ...
    listCampaignCreators: async (input) => {
      ...
      return campaignRosterGuidance(
        ...
        parsedInput.campaign_id,
        compactJsonObject(Object.entries(parsedInput)),
      );
    },
    ...
    startEmailUnlock: async (input) => startEmailUnlock(client, input),

    getEmailUnlockJob: async (input) => getEmailUnlockJob(client, input),
